...
(function ($){
	$(function(){
		...
		function insertButtons(typeOfInsert, heName){
			...
			//change modal
			$("#intro").append('<button class="usrBttns btn-floating btn-large waves-effect waves-light red tooltipped" data-position="left" data-delay="50" data-tooltip=" מחק ' +heName+ '" type="submit" name="action" id = "deleteRecord"></button>');
			$("#deleteRecord").append('<i class="material-icons">delete</i>');

			//change modal
			$("#intro").append('<button class="usrBttns btn-floating btn-large waves-effect waves-light light-blue lighten-1 tooltipped" data-position="top" data-delay="50" data-tooltip="ערוך ' +heName+ '" type="submit" name="action" id = "edit' +typeOfInsert+ '"></button>');
